...
// import homeBG from "../assets/HomeBG5.jpg";
// import homeBG from "../assets/HomeBG7.jpg";
// import homeBG from "../assets/HomePageBackground.jpg";
  ...
  return (
    <>
      <div className='relative z-10'>
        <Hero />
        <section className='text-center px-6 py-20 max-w-3xl mx-auto relative z-10'>
